/**
 * @file Header.jsx
 * @description Cabecera minimalista para la pagina de la inmobiliaria.
 */
...
/**
 * Cabecera con navegacion y contacto.
 * @return {JSX.Element}
 */
export const Header = () => {
    return (
                ...
                <div className="flex items-center gap-3">
                        ...
                        <div>
                                  <h1 className="text-xl font-black text-accent m-0 leading-tight uppercase tracking-tighter">
                                              Viglio <span className="text-primary">Real Estate</span>span>
                                  </h1>h1>
                                  <p className="text-[10px] text-muted font-bold uppercase tracking-widest -mt-1 opacity-80">Premium Services Since 1998</p>p>
                        </div>div>
                </div>div>
                  ...
                  {['Inicio', 'Propiedades', 'Sobre Nosotros', 'Servicios'].map((item) => (
                      <a 
                        ...
                        href={`#${item.toLowerCase().replace(' ', '-')}`}
                                  ...
                                  >
                        {item}
                                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>span>
                      </a>a>
                    ))}
                </nav>nav>
